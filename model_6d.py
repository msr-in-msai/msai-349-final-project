...
class PointNet(nn.Module):
    ...
    def loss(self,
        ...
        :param tnet6: Output of the first Tnet.
        :type tnet6: torch.Tensor
        ...
        i6 = torch.eye(6, requires_grad=True).repeat(
            batch_size, 1, 1)
        ...
        return criterion(outputs, labels) + regularize_weight * (
            torch.norm(diff6)+torch.norm(diff64)) / float(batch_size)
